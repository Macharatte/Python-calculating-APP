...
<style>
    ...
    button[key="k_+"] {
        background-image: url("data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='40' height='40' viewBox='0 0 40 40'><path d='M20 10 v20 M10 20 h20' stroke='black' stroke-width='6' stroke-linecap='round'/></svg>") !important;
        background-repeat: no-repeat !important; background-position: center !important; color: rgba(0,0,0,0) !important;
    }
    .display-box { font-size: 30px; font-weight: bold; text-align: right; padding: 10px; background: #f8f9fa; border: 2px solid #333; border-radius: 8px; min-height: 55px; margin-bottom: 5px; }
</style>
